...
<div class="container mt-5">
    <nav>
        <ol class="breadcrumb  bg-transparent pl-0">
            ...
            <li class="breadcrumb-item"><a href="/listmenu/menudaging">Menudaging</a></li>
            <li class="breadcrumb-item active" aria-current="page">menu <?php echo $daging['judul']; ?></li>
        </ol>
    </nav>
</div>
...
<section class="single-product">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <figure class="figure">
                    <img src="/assets/img/menudaging/<?php echo $daging['sampul']; ?>" class="figure-img img-fluid">
                </figure>
            </div>
            <div class="col-lg-4 text-center">
                <h5><?php echo $daging['judul']; ?></h5>
                <p class="text-muted"><span style="font-weight: 600;">Rp </span> <?php echo $daging['harga']; ?></p>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="whatsapp-form">
                                    ...
                                    <div class="datainput">
                                        <p class="validate" id="wa_url" name="url">https://warungmakanan/Listmenu/detaildaging/<?php echo $daging['slug']; ?></p>
                                </form>
                            </div>
