...
<div class="container mt-5">
    <nav>
        <ol class="breadcrumb  bg-transparent pl-0">
            ...
            <li class="breadcrumb-item"><a href="/listmenu/menuayam">Menuayam</a></li>
            <li class="breadcrumb-item active" aria-current="page">menu <?php echo $ayam['judul']; ?></li>
        </ol>
    </nav>
</div>
...
<section class="single-product">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <figure class="figure">
                    <img src="/assets/img/menuayam/<?php echo $ayam['sampul']; ?>" class="figure-img img-fluid">
                </figure>
            </div>
            <div class="col-lg-4 text-center">
                <h5><?php echo $ayam['judul']; ?></h5>
                <p class="text-muted"><span style="font-weight: 600;">Rp </span> <?php echo $ayam['harga']; ?></p>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="whatsapp-form">
                                    ...
                                    <div class="datainput">
                                        <p class="validate" id="wa_url" name="url">https://warungmakanan.com/Listmenu/detailayam/<?php echo $ayam['slug']; ?></p>
                                </form>
                            </div>
        ...
        <div class="conta">
            ...
            <div class="d-flex table-responsive mt-2 mb-2">
                <?php foreach ($lainya as $w => $da) : ?>
                    ...
                    <div class="allbox">
                        <div class="crh">
                            <img src="/assets/img/menuayam/<?php echo $da['sampul']; ?>" class="im-crh">
                            <a href="/listmenu/detailayam/<?php echo $da['slug']; ?>" class="d-flex justify-content-center">
